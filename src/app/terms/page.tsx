...
export const metadata: Metadata = {
  ...
  description: "Terms and conditions for Personal Journal",
  openGraph: {
    ...defaultMetadata.openGraph,
    title: "Terms & Conditions | Personal Journal",
    description: "Terms and conditions for Personal Journal",
  },
}
    ...
    <div className="py-24 bg-light dark:bg-dark">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg dark:prose-invert">
          <p>
            We use Apple's standard End User License Agreement (EULA).
          ...
          <p>
            These terms and conditions applies to the Personal Journal App (hereby referred to as "Application") 
            for mobile devices that was created by Marco Caldera (hereby referred to as "Service Provider") as 
          ...
          <h2>Network Connectivity and Charges</h2>
          <p>
          ...
          <p>
            ...
            application, you accept responsibility for any such charges, including roaming data charges if you 
          ...
          <p>
            ...
            For instance, it is your responsibility to ensure that your device remains charged. If your device 
            runs out of battery and you are unable to access the Service, the Service Provider cannot be held 
            responsible.
          </p>
          <p>
          ...
          <p>
            ...
            updates to the application when offered to you. The Service Provider may also wish to cease providing 
            the application and may terminate its use at any time without providing termination notice to you. 
            Unless they inform you otherwise, upon any termination, (a) the rights and licenses granted to you 
            in these terms will end; (b) you must cease using the application, and (if necessary) delete it 
            from your device.
          </p>
          ...
          <p>
            These terms and conditions are effective as of 12th January 2025.
          </p>
          ...
          <p className="text-sm text-gray-500 mt-2">
            This Terms and Conditions page was generated using{" "}
            <a 
